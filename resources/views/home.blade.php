...
@section("body")
    ...
    <section class="jumbotron text-center">
        <img src="{{ asset('template/img/defaultProfile.png') }}" alt="aaa" width="200" class=" rounded-circle img-thumbnail">
        <h1 class="display-4">Elang Pandi Pranoto</h1>
        <p class="lead">12 RPL 1 | Absen 26</p>
    </section>

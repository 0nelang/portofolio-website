            ...
            <form action="{{ Route('siswa.update', ['siswa' => $siswa->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="mb-3">
                        ...
                        @enderror
                        <div class="col-md-3">
                            <img id="output" class="mt-3" style="max-height: 200px; max-width: 300px;" src="{{ asset('storage/'. $siswa->foto) }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control  @error('about') is-invalid @enderror" id="about" rows="3" name="about">{{ $siswa->email }}</textarea>
                        @error('about')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
